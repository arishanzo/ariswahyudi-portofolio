    ...
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="flex flex-wrap justify-center gap-4 mb-10">
        <button
          ...
          :class="activeCategory === cat
            ...
            : 'bg-white/70 backdrop-blur-sm text-gray-700 border border-white/50 hover:bg-white/90'"
        >{{ cat }}</button>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          ...
          class="bg-white/75 backdrop-blur-sm rounded-xl shadow-md overflow-hidden border border-white/50 hover:border-orange-400 transition transform hover:-translate-y-1 hover:shadow-xl"
        >
          <div class="relative aspect-video overflow-hidden">
            <img :src="project.img" :alt="project.title"
                 class="w-full h-full object-contain transition-transform duration-500 hover:scale-105 bg-gray-50/80" />
          ...
          <div class="p-6">
            ...
            <div class="flex flex-wrap gap-2 mb-4">
              <img v-for="tag in project.tags" :key="tag" :src="`${tag}`" :alt="tag"
            ...
            <div class="flex gap-4">
              ...
              <a :href="project.link"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path d="M1.5 12s4-7.5 10.5-7.5S22.5 12 22.5 12s-4 7.5-10.5 7.5S1.5 12 1.5 12Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
